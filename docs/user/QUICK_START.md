...
1. Extract the complete v0.1.4 release ZIP.
...
4. For the released v0.1.4 package, confirm version `0.1.4`, 79 registered C++ commands, 78 Add-On descriptor/MCP tools, and 4 Workbench Server tools.
